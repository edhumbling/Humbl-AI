...
import { Mic, ArrowUp, Square, Plus, X, Image as ImageIcon, ChevronDown, Check, Edit2, MoreVertical, Download, Copy as CopyIcon, Info, ThumbsUp, ThumbsDown, RefreshCw, Volume2, VolumeX, Share2, ChevronLeft, ChevronRight, Maximize2, Minimize2, Globe, Lightbulb, Menu } from 'lucide-react';
...
export default function MessageSharePage() {
  ...
  const handleVote = async (messageIndex: number, vote: 'up' | 'down') => {
    ...
    try {
      // Use continuationConversationId (the actual conversation ID) for voting
      const convId = continuationConversationId;
